...
#| fig-alt: "Horizontal bar chart showing differences in climate hazard risk exposure across racial and ethnic groups in California. Asian and Black populations have the highest above-average exposure, while White populations are slightly below average. Data are from FEMA National Risk Index and the American Community Survey."

# Custom color palette - using colorblind-friendly colors
race_colors <- c("White" = "#4477AA",
                 "Black or African American" = "#EE6677",
                 "American Indian and Alaska Native" = "#228833",
                 "Asian" = "#997700",
                 "Native Hawaiian and Other Pacific Islander" = "#66CCEE",
                 "Some Other Race" = "#AA3377",
                 "Two or More Races" = "#BBBBBB",
                 "Hispanic or Latino" = "#DD5500")
...
- Asian and Black Californians show the largest above-average exposure to climate hazard risk compared with the statewide average. White Californians are slightly below the California average, while most other groups are near zero.
