...
This project uses the FEMA National Risk Index (NRI) dataset (2025 Release), which provides county-level measures of disaster risk across the United States. Only data from the 50 US states are included in this analysis; territories are excluded.
